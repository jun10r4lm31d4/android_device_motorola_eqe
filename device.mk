...
# Kernel
PRODUCT_PACKAGES += $(strip $(shell cat $(LOCAL_PATH)/configs/motorola.modules))

KERNEL_PREBUILT_DIR := device/qcom/crow-kernel
...
# Motorola Firmware Mountpoints
PRODUCT_PACKAGES += \
    vendor_bt_firmware_mountpoint \
    vendor_dsp_mountpoint \
    vendor_firmware_mnt_mountpoint \
    vendor_fsg_mountpoint \
    rfs_mdm_mpss_readonly_fsg_symlink \
